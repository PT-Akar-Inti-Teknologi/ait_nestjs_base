...
exports.FirebaseStorageServices = void 0;
...
class FirebaseStorageServices {
    constructor(config) {
        this.log = new common_1.Logger(FirebaseStorageServices.name);
        this.expireDays = 7;
        this.bucket = new storage_1.Storage(config.firebaseInitOptions).bucket(config.firebaseBucket);
    }
    getRootFolderName() {
        return '';
    }
...
exports.FirebaseStorageServices = FirebaseStorageServices;
//# sourceMappingURL=firebase-storage.services.js.map