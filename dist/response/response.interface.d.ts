/** config needed by Response Service */
export declare class ResponseServiceConfig {
    /** project name */
    projectName: string;
    /** service name */
    serviceName: string;
...
export interface ListPaginationInterface<Entity> {
...
export interface ResponseSuccessPaginationInterface extends ResponseInterface {
    readonly response_output: {
        list: ListPaginationInterface<any>;
    };
}
...
export type IApplyDecorator = <TFunction extends Function, Y>(target: Record<string, any> | TFunction, propertyKey?: string | symbol, descriptor?: TypedPropertyDescriptor<Y>) => void;
