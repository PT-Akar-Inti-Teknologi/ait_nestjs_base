...
let InternalServiceBase = class InternalServiceBase {
    ...
    repositoryOf(entityName) {
        var _a;
        const entity = (_a = (0, typeorm_1.getMetadataArgsStorage)().tables.find((t) => t.name ===
            `${this.tablePrefix ? `${this.tablePrefix}_` : ''}${entityName.toLowerCase()}`)) === null || _a === void 0 ? void 0 : _a.target;
        if (!entity) {
