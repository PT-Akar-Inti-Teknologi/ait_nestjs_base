 ...
 */
export declare abstract class BaseController<CreateDTO, UpdateDTO, EntityDocument, PagingDTO extends MainPagingDTO = MainPagingDTO> {
     ...
     */
    findAll(mainPagingDTO: PagingDTO): Promise<ResponseSuccessPaginationInterface>;
    /**
     ...
     */
    show(id: string): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     */
    save(createDTO: CreateDTO, user?: IUser): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     */
    update(id: string, updateDTO: UpdateDTO, user?: IUser): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     */
    delete(id: string): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     */
    baseFindAll(mainPagingDTO: PagingDTO): Promise<ResponseSuccessPaginationInterface>;
    /**
     ...
     * `baseMessageService`.
     */
    baseShow(id: string): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     * `baseMessageService`.
     */
    baseSave(createDTO: CreateDTO): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     */
    baseUpdate(updateDTO: UpdateDTO, id: string): Promise<ResponseSuccessSingleInterface>;
    /**
     ...
     */
    baseDelete(id: string): Promise<ResponseSuccessSingleInterface>;
}
