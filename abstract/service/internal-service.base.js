...
let InternalServiceBase = exports.InternalServiceBase = class InternalServiceBase {
    /**
    ...
    async toEntityAndValidate(isUpdate, param, target) {
        const entity = (0, class_transformer_1.plainToInstance)(target, param);
...
exports.InternalServiceBase = InternalServiceBase = __decorate([
