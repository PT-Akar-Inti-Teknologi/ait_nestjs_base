import { UpdateResult, Repository, SelectQueryBuilder, WhereExpressionBuilder } from 'typeorm';
 ...
 */
export declare class BaseService<CreateDTO, UpdateDTO, EntityDocument, PagingDTO extends PaginationRequestDTO = PaginationRequestDTO> {
     ...
     */
    findAll(mainPagingDTO: PagingDTO): Promise<ListPaginationDTO>;
    /**
     ...
     * @returns - Result of the delete operation
     */
    baseDelete(id: string): Promise<UpdateResult>;
    /**
     * Find all entities in the database
     * @param mainPagingDTO - The DTO containing pagination data
     * @returns - The list of entities and pagination details
     */
    baseFindAll(mainPagingDTO: PagingDTO): Promise<ListPaginationDTO>;
    /**
     ...
     * @param queryBuilder - query builder
     */
    baseFilterAllQuery(mainPagingDTO: PagingDTO, filterQuery: BaseFilterInterface<PagingDTO>[], queryBuilder: SelectQueryBuilder<EntityDocument> | WhereExpressionBuilder): void;
    /**
     ...
     */
    baseFindDetailAll(mainPagingDTO: PagingDTO, relations?: string[]): Promise<ListPaginationDTO>;
    /**
