...
export declare abstract class InternalServiceBase<BaseEntityInternal extends {
     ...
     */
    protected constructor(responseService: ResponseService, messageService: MessageService, dataSource: DataSource, moduleRef: ModuleRef);
    ...
    add(entityName: EntityName, param: Partial<BaseEntityInternal>): Promise<ResponseSuccessSingleDTO>;
    update(entityName: EntityName, id: string, param: Partial<BaseEntityInternal>): Promise<ResponseSuccessSingleDTO>;
    delete(entityName: EntityName, id: string): Promise<ResponseSuccessSingleDTO>;
    /**
