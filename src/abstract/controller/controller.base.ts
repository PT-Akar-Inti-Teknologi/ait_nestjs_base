...
> {
  ...
  ): Promise<ResponseSuccessCollectionDTO> {
   ...
   */
  @Get('/:id')
  async show(@Param('id') id: string): Promise<ResponseSuccessSingleDTO> {
   ...
   */
  @Delete('/:id')
  async delete(@Param('id') id: string): Promise<ResponseSuccessSingleDTO> {
   ...
   * `baseMessageService`.
   */
  async baseShow(id: string): Promise<ResponseSuccessSingleDTO> {
   ...
   * `baseMessageService`.
   */
  async baseSave(createDTO: CreateDTO): Promise<ResponseSuccessSingleDTO> {
   ...
   */
  async baseDelete(id: string): Promise<ResponseSuccessSingleDTO> {
    return this.baseResponseService.success(
