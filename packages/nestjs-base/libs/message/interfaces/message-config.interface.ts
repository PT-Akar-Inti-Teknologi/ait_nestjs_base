...
export abstract class AitMessageConfig {
...
export class AitMessageConfigI18n
  extends AitMessageConfig
  implements I18nOptions
{
  useNestI18n: true;
  fallbackLanguage: string;
...
export class AitMessageConfigLocal extends AitMessageConfig {
  useNestI18n: false;
  fallbackLanguage: string;
